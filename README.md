...
This validator now lives in the [Guardrails Hub monorepo](https://github.com/guardrails-ai/guardrails-hub-monorepo/tree/main/has_url/py).
**This repository is archived and no longer maintained** — please open issues and pull
requests on the monorepo instead.

```bash
pip install guardrails-ai-has-url
```

```python
from guardrails import Guard
from guardrails_ai.has_url import HasUrl

guard = Guard().use(HasUrl)
```
